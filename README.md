...
- **Security level is set separately** via `security_level` parameter — determines encryption strength (128/192/256-bit). Higher security = less available mult depth for same `poly_mod_degree`
