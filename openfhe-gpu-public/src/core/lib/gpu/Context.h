...
class Context {
 ...
 public:
  ...
  CtAccurate EvalMultAndRelinNoRescale(const CtAccurate& ct1, const CtAccurate& ct2, const EvaluationKey& evk) const;
  ...
  CtAccurate EvalAddPlain(const CtAccurate& ct, const PtAccurate& pt) const;

  CtAccurate EvalSubPlain(const CtAccurate& ct, const PtAccurate& pt) const;
