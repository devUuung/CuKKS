# GPU Acceleration for CuKKS

## Overview

CuKKS supports GPU acceleration for homomorphic encryption operations using the OpenFHE-GPU library. The implementation uses a hybrid CPU/GPU approach:
